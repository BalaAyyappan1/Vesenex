    ...
    <Layout>
      ...
      >
        <div className="flex flex-col gap-5 max-w-xl  ">
          <h1 className="text-[36px] font-medium leading-[100%] bg-gradient-to-r from-[#F1F2F3] to-[#26282B] bg-clip-text text-transparent">
            Get a free cybersecurity assessment and see how we can protect you
            better
          </h1>

          <p className="text-[#D6D9DC] leading-[22px] font-light text-[20px]">
